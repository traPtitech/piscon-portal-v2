...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        InstanceStatus: "building" | "running" | "stopped" | "deleted";
        /**
         * @example start
         * @enum {string}
         */
        ...
        Score: number;
        /** @description ベンチマーク */
        BenchmarkListItem: components["schemas"]["WaitingBenchmark"] | components["schemas"]["RunningBenchmark"] | components["schemas"]["FinishedBenchmark"];
        /** @description ベンチマーク結果 */
        Benchmark: (components["schemas"]["WaitingBenchmark"] | components["schemas"]["RunningBenchmark"] | components["schemas"]["FinishedBenchmark"]) & {
            /**
        ...
        BenchmarkAdminResult: (components["schemas"]["WaitingBenchmark"] | components["schemas"]["RunningBenchmark"] | components["schemas"]["FinishedBenchmark"]) & {
            /**
             * @description ベンチマークの競技者用ログ（標準出力）
             * @example log
             */
