...
var BenchmarkLogs = mysql.NewTablex[*BenchmarkLog, BenchmarkLogSlice, *BenchmarkLogSetter]("benchmark_logs", buildBenchmarkLogColumns("benchmark_logs"), []string{"benchmark_id"})
