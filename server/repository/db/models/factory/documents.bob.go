...
type DocumentMod interface {
	Apply(*DocumentTemplate)
}

type DocumentModFunc func(*DocumentTemplate)

func (f DocumentModFunc) Apply(n *DocumentTemplate) {
	f(n)
}

type DocumentModSlice []DocumentMod

func (mods DocumentModSlice) Apply(n *DocumentTemplate) {
	for _, f := range mods {
		f.Apply(n)
	}
}
...
func (o *DocumentTemplate) Apply(mods ...DocumentMod) {
...
func (m documentMods) ID(val string) DocumentMod {
	return DocumentModFunc(func(o *DocumentTemplate) {
