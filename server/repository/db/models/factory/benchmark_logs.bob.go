...
type BenchmarkLogMod interface {
	Apply(*BenchmarkLogTemplate)
}

type BenchmarkLogModFunc func(*BenchmarkLogTemplate)

func (f BenchmarkLogModFunc) Apply(n *BenchmarkLogTemplate) {
	f(n)
}

type BenchmarkLogModSlice []BenchmarkLogMod

func (mods BenchmarkLogModSlice) Apply(n *BenchmarkLogTemplate) {
	for _, f := range mods {
		f.Apply(n)
	}
}
...
func (o *BenchmarkLogTemplate) Apply(mods ...BenchmarkLogMod) {
...
func ensureCreatableBenchmarkLog(m *models.BenchmarkLogSetter) {
	if m.BenchmarkID.IsUnset() {
		m.BenchmarkID = omit.From(random_string(nil))
	}
...
func (o *BenchmarkLogTemplate) create(ctx context.Context, exec bob.Executor) (context.Context, *models.BenchmarkLog, error) {
	...
	if o.r.Benchmark == nil {
		var ok bool
		rel0, ok = benchmarkCtx.Value(ctx)
		if !ok {
			BenchmarkLogMods.WithNewBenchmark().Apply(o)
		}
	}
	if o.r.Benchmark != nil {
...
func (m benchmarkLogMods) BenchmarkID(val string) BenchmarkLogMod {
	return BenchmarkLogModFunc(func(o *BenchmarkLogTemplate) {
...
func (m benchmarkLogMods) WithNewBenchmark(mods ...BenchmarkMod) BenchmarkLogMod {
	return BenchmarkLogModFunc(func(o *BenchmarkLogTemplate) {
		...
		m.WithBenchmark(related).Apply(o)
	})
}
