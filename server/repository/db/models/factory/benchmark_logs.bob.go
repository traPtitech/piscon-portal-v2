...
func (t BenchmarkLogTemplate) setModelRels(o *models.BenchmarkLog) {
	if t.r.Benchmark != nil {
		rel := t.r.Benchmark.o.Build()
		rel.R.BenchmarkLog = o
		o.BenchmarkID = rel.ID // h2
		o.R.Benchmark = rel
	}
}
...
func (o BenchmarkLogTemplate) BuildSetter() *models.BenchmarkLogSetter {
	...
	if o.BenchmarkID != nil {
		val := o.BenchmarkID()
		m.BenchmarkID = omit.From(val)
	}
	if o.UserLog != nil {
		val := o.UserLog()
		m.UserLog = omit.From(val)
	}
	if o.AdminLog != nil {
		val := o.AdminLog()
		m.AdminLog = omit.From(val)
	}
...
func ensureCreatableBenchmarkLog(m *models.BenchmarkLogSetter) {
	if !(m.BenchmarkID.IsValue()) {
		val := random_string(nil, "36")
		m.BenchmarkID = omit.From(val)
	}
	if !(m.UserLog.IsValue()) {
		val := random_string(nil)
		m.UserLog = omit.From(val)
	}
	if !(m.AdminLog.IsValue()) {
		val := random_string(nil)
		m.AdminLog = omit.From(val)
	}
}
...
func (o *BenchmarkLogTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.BenchmarkLog) error {
	var err error
...
func (o *BenchmarkLogTemplate) Create(ctx context.Context, exec bob.Executor) (*models.BenchmarkLog, error) {
	...
	var rel0 *models.Benchmark

	if o.r.Benchmark.o.alreadyPersisted {
		rel0 = o.r.Benchmark.o.Build()
	} else {
		rel0, err = o.r.Benchmark.o.Create(ctx, exec)
		if err != nil {
			return nil, err
		}
	}
...
func (m benchmarkLogMods) WithParentsCascading() BenchmarkLogMod {
	return BenchmarkLogModFunc(func(ctx context.Context, o *BenchmarkLogTemplate) {
		...
		ctx = benchmarkLogWithParentsCascadingCtx.WithValue(ctx, true)
		{
			...
			related := o.f.NewBenchmarkWithContext(ctx, BenchmarkMods.WithParentsCascading())
...
func (m benchmarkLogMods) WithNewBenchmark(mods ...BenchmarkMod) BenchmarkLogMod {
	return BenchmarkLogModFunc(func(ctx context.Context, o *BenchmarkLogTemplate) {
		related := o.f.NewBenchmarkWithContext(ctx, mods...)

		m.WithBenchmark(related).Apply(ctx, o)
	})
}

func (m benchmarkLogMods) WithExistingBenchmark(em *models.Benchmark) BenchmarkLogMod {
	return BenchmarkLogModFunc(func(ctx context.Context, o *BenchmarkLogTemplate) {
		o.r.Benchmark = &benchmarkLogRBenchmarkR{
			o: o.f.FromExistingBenchmark(em),
		}
	})
}
