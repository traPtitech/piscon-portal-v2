...
func (t UserTemplate) setModelRels(o *models.User) {
	...
	if t.r.Team != nil {
		...
		o.TeamID = sql.Null[string]{V: rel.ID, Valid: true} // h2
		o.R.Team = rel
	}
}
...
// Set the model columns to this value
func (m userMods) TeamID(val sql.Null[string]) UserMod {
	return UserModFunc(func(_ context.Context, o *UserTemplate) {
		o.TeamID = func() sql.Null[string] { return val }
	})
}

// Set the Column from the function
func (m userMods) TeamIDFunc(f func() sql.Null[string]) UserMod {
	return UserModFunc(func(_ context.Context, o *UserTemplate) {
		o.TeamID = f
	})
}
...
func (m userMods) WithNewSessions(number int, mods ...SessionMod) UserMod {
	return UserModFunc(func(ctx context.Context, o *UserTemplate) {
		related := o.f.NewSession(ctx, mods...)
