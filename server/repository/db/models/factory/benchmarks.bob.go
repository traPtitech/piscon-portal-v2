...
func (o BenchmarkTemplate) BuildSetter() *models.BenchmarkSetter {
	...
	if o.Score != nil {
		val := o.Score()
		m.Score = omit.From(val)
	}
	if o.Result != nil {
		val := o.Result()
		m.Result = omitnull.FromNull(val)
	}
...
func (o *BenchmarkTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.Benchmark) error {
	var err error
	...
	if !isBenchmarkLogDone && o.r.BenchmarkLog != nil {
		...
		if o.r.BenchmarkLog.o.alreadyPersisted {
			m.R.BenchmarkLog = o.r.BenchmarkLog.o.Build()
		} else {
			var rel0 *models.BenchmarkLog
			rel0, err = o.r.BenchmarkLog.o.Create(ctx, exec)
			if err != nil {
				return err
			}
...
func (o *BenchmarkTemplate) Create(ctx context.Context, exec bob.Executor) (*models.Benchmark, error) {
	...
	if o.r.Instance.o.alreadyPersisted {
		rel1 = o.r.Instance.o.Build()
	} else {
		rel1, err = o.r.Instance.o.Create(ctx, exec)
		if err != nil {
			return nil, err
		}
	}
...
func (m benchmarkMods) WithParentsCascading() BenchmarkMod {
	return BenchmarkModFunc(func(ctx context.Context, o *BenchmarkTemplate) {
		...
		ctx = benchmarkWithParentsCascadingCtx.WithValue(ctx, true)
		{
			...
			related := o.f.NewBenchmarkLogWithContext(ctx, BenchmarkLogMods.WithParentsCascading())
			m.WithBenchmarkLog(related).Apply(ctx, o)
		}
		{

			related := o.f.NewInstanceWithContext(ctx, InstanceMods.WithParentsCascading())
...
func (m benchmarkMods) WithNewBenchmarkLog(mods ...BenchmarkLogMod) BenchmarkMod {
	return BenchmarkModFunc(func(ctx context.Context, o *BenchmarkTemplate) {
		related := o.f.NewBenchmarkLogWithContext(ctx, mods...)

		m.WithBenchmarkLog(related).Apply(ctx, o)
	})
}

func (m benchmarkMods) WithExistingBenchmarkLog(em *models.BenchmarkLog) BenchmarkMod {
	return BenchmarkModFunc(func(ctx context.Context, o *BenchmarkTemplate) {
		o.r.BenchmarkLog = &benchmarkRBenchmarkLogR{
			o: o.f.FromExistingBenchmarkLog(em),
		}
	})
}
...
func (m benchmarkMods) WithNewInstance(mods ...InstanceMod) BenchmarkMod {
	return BenchmarkModFunc(func(ctx context.Context, o *BenchmarkTemplate) {
		related := o.f.NewInstanceWithContext(ctx, mods...)

		m.WithInstance(related).Apply(ctx, o)
	})
}

func (m benchmarkMods) WithExistingInstance(em *models.Instance) BenchmarkMod {
	return BenchmarkModFunc(func(ctx context.Context, o *BenchmarkTemplate) {
		o.r.Instance = &benchmarkRInstanceR{
			o: o.f.FromExistingInstance(em),
		}
	})
}
