...
func (o InstanceTemplate) BuildSetter() *models.InstanceSetter {
	...
	if o.ProviderInstanceID != nil {
		...
		m.ProviderInstanceID = omit.From(val)
	}
	if o.TeamID != nil {
		val := o.TeamID()
	...
	if o.InstanceNumber != nil {
		...
		m.InstanceNumber = omit.From(val)
	}
	if o.CreatedAt != nil {
		val := o.CreatedAt()
...
func ensureCreatableInstance(m *models.InstanceSetter) {
	...
	if !(m.ProviderInstanceID.IsValue()) {
...
func (o *InstanceTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.Instance) error {
	var err error
	...
	if !isBenchmarksDone && o.r.Benchmarks != nil {
		...
		for _, r := range o.r.Benchmarks {
			if r.o.alreadyPersisted {
				m.R.Benchmarks = append(m.R.Benchmarks, r.o.Build())
			} else {
...
// Set the model columns to this value
func (m instanceMods) DeletedAt(val null.Val[time.Time]) InstanceMod {
	return InstanceModFunc(func(_ context.Context, o *InstanceTemplate) {
...
// Set the Column from the function
func (m instanceMods) DeletedAtFunc(f func() null.Val[time.Time]) InstanceMod {
	return InstanceModFunc(func(_ context.Context, o *InstanceTemplate) {
		o.DeletedAt = f
	})
}
...
func (m instanceMods) AddExistingBenchmarks(existingModels ...*models.Benchmark) InstanceMod {
	return InstanceModFunc(func(ctx context.Context, o *InstanceTemplate) {
