// Code generated by BobGen mysql v0.43.0. DO NOT EDIT.
...
func buildTeamColumns(tableName string) teamColumns {
	...
	return teamColumns{
		...
		ID:          mysql.Quote(tableName, "id"),
		Name:        mysql.Quote(tableName, "name"),
		CreatedAt:   mysql.Quote(tableName, "created_at"),
	}
}
