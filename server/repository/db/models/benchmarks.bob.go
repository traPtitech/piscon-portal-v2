...
func (s BenchmarkSetter) Overwrite(t *Benchmark) {
	...
	if s.InstanceID.IsValue() {
		t.InstanceID = s.InstanceID.MustGet()
	}
	if s.TeamID.IsValue() {
...
func (s *BenchmarkSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(
		bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
			...
			return mysql.Arg(s.InstanceID.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
			if !s.TeamID.IsValue() {
				return mysql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return mysql.Arg(s.TeamID.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
			if !s.UserID.IsValue() {
				return mysql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			...
			return mysql.Arg(s.StartedAt.MustGetNull()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
			if !!s.FinishedAt.IsUnset() {
				return mysql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return mysql.Arg(s.FinishedAt.MustGetNull()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
			if !s.Score.IsValue() {
				return mysql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return mysql.Arg(s.Score.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
			if !!s.Result.IsUnset() {
				return mysql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			...
			return mysql.Arg(s.ErrorMessage.MustGetNull()).WriteSQL(ctx, w, d, start)
		}))
}
