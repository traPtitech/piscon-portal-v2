...
func buildBenchmarkColumns(tableName string) benchmarkColumns {
	...
	return benchmarkColumns{
		...
		InstanceID:   mysql.Quote(tableName, "instance_id"),
		TeamID:       mysql.Quote(tableName, "team_id"),
		UserID:       mysql.Quote(tableName, "user_id"),
		Status:       mysql.Quote(tableName, "status"),
		CreatedAt:    mysql.Quote(tableName, "created_at"),
		StartedAt:    mysql.Quote(tableName, "started_at"),
		FinishedAt:   mysql.Quote(tableName, "finished_at"),
		Score:        mysql.Quote(tableName, "score"),
		Result:       mysql.Quote(tableName, "result"),
		ErrorMessage: mysql.Quote(tableName, "error_message"),
	}
}
