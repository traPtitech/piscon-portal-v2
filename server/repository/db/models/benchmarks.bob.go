...
func (s BenchmarkSetter) Overwrite(t *Benchmark) {
	...
	if !s.InstanceID.IsUnset() {
		t.InstanceID, _ = s.InstanceID.Get()
	}
	if !s.TeamID.IsUnset() {
	...
	if !s.FinishedAt.IsUnset() {
		t.FinishedAt, _ = s.FinishedAt.GetNull()
	}
	if !s.Score.IsUnset() {
		t.Score, _ = s.Score.Get()
	}
	if !s.Result.IsUnset() {
...
type benchmarkJoins[Q dialect.Joinable] struct {
	typ          string
	BenchmarkLog func(context.Context) modAs[Q, benchmarkLogColumns]
	Instance     func(context.Context) modAs[Q, instanceColumns]
}
...
func buildBenchmarkJoins[Q dialect.Joinable](cols benchmarkColumns, typ string) benchmarkJoins[Q] {
	return benchmarkJoins[Q]{
		typ:          typ,
		BenchmarkLog: benchmarksJoinBenchmarkLog[Q](cols, typ),
		Instance:     benchmarksJoinInstance[Q](cols, typ),
	}
}

func benchmarksJoinBenchmarkLog[Q dialect.Joinable](from benchmarkColumns, typ string) func(context.Context) modAs[Q, benchmarkLogColumns] {
	return func(ctx context.Context) modAs[Q, benchmarkLogColumns] {
		return modAs[Q, benchmarkLogColumns]{
...
func benchmarksJoinInstance[Q dialect.Joinable](from benchmarkColumns, typ string) func(context.Context) modAs[Q, instanceColumns] {
	return func(ctx context.Context) modAs[Q, instanceColumns] {
		return modAs[Q, instanceColumns]{
			c: InstanceColumns,
...
func (os BenchmarkSlice) BenchmarkLog(mods ...bob.Mod[*dialect.SelectQuery]) BenchmarkLogsQuery {
	...
	return BenchmarkLogs.Query(append(mods,
		sm.Where(mysql.Group(BenchmarkLogColumns.BenchmarkID).In(PKArgs...)),
	)...)
}
...
func (os BenchmarkSlice) Instance(mods ...bob.Mod[*dialect.SelectQuery]) InstancesQuery {
	PKArgs := make([]bob.Expression, len(os))
	for i, o := range os {
		PKArgs[i] = mysql.ArgGroup(o.InstanceID)
	}

	return Instances.Query(append(mods,
		sm.Where(mysql.Group(InstanceColumns.ID).In(PKArgs...)),
	)...)
}
...
func PreloadBenchmarkBenchmarkLog(opts ...mysql.PreloadOption) mysql.Preloader {
...
func ThenLoadBenchmarkBenchmarkLog(queryMods ...bob.Mod[*dialect.SelectQuery]) mysql.Loader {
	return mysql.Loader(func(ctx context.Context, exec bob.Executor, retrieved any) error {
		loader, isLoader := retrieved.(interface {
			LoadBenchmarkBenchmarkLog(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
		})
		if !isLoader {
			return fmt.Errorf("object %T cannot load BenchmarkBenchmarkLog", retrieved)
		}

		err := loader.LoadBenchmarkBenchmarkLog(ctx, exec, queryMods...)
...
// LoadBenchmarkBenchmarkLog loads the benchmark's BenchmarkLog into the .R struct
func (o *Benchmark) LoadBenchmarkBenchmarkLog(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}
...
// LoadBenchmarkBenchmarkLog loads the benchmark's BenchmarkLog into the .R struct
func (os BenchmarkSlice) LoadBenchmarkBenchmarkLog(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}
...
func PreloadBenchmarkInstance(opts ...mysql.PreloadOption) mysql.Preloader {
...
func ThenLoadBenchmarkInstance(queryMods ...bob.Mod[*dialect.SelectQuery]) mysql.Loader {
	return mysql.Loader(func(ctx context.Context, exec bob.Executor, retrieved any) error {
		loader, isLoader := retrieved.(interface {
			LoadBenchmarkInstance(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
		})
		if !isLoader {
			return fmt.Errorf("object %T cannot load BenchmarkInstance", retrieved)
		}

		err := loader.LoadBenchmarkInstance(ctx, exec, queryMods...)
...
// LoadBenchmarkInstance loads the benchmark's Instance into the .R struct
func (o *Benchmark) LoadBenchmarkInstance(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}
...
// LoadBenchmarkInstance loads the benchmark's Instance into the .R struct
func (os BenchmarkSlice) LoadBenchmarkInstance(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}
...
func insertBenchmarkBenchmarkLog0(ctx context.Context, exec bob.Executor, benchmarkLog1 *BenchmarkLogSetter, benchmark0 *Benchmark) (*BenchmarkLog, error) {
	benchmarkLog1.BenchmarkID = omit.From(benchmark0.ID)
...
func attachBenchmarkBenchmarkLog0(ctx context.Context, exec bob.Executor, count int, benchmarkLog1 *BenchmarkLog, benchmark0 *Benchmark) (*BenchmarkLog, error) {
	setter := &BenchmarkLogSetter{
		BenchmarkID: omit.From(benchmark0.ID),
	}
...
func attachBenchmarkInstance0(ctx context.Context, exec bob.Executor, count int, benchmark0 *Benchmark, instance1 *Instance) (*Benchmark, error) {
	setter := &BenchmarkSetter{
		InstanceID: omit.From(instance1.ID),
	}
