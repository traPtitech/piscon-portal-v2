...
func buildInstanceColumns(tableName string) instanceColumns {
	...
	return instanceColumns{
		...
		ProviderInstanceID: mysql.Quote(tableName, "provider_instance_id"),
		TeamID:             mysql.Quote(tableName, "team_id"),
		InstanceNumber:     mysql.Quote(tableName, "instance_number"),
		CreatedAt:          mysql.Quote(tableName, "created_at"),
		DeletedAt:          mysql.Quote(tableName, "deleted_at"),
	}
}
